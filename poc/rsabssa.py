...
def test(
    ...
    msg_prefix = bytes()
    if randomize:
        prepared_msg = rsabssa_randomize(msg)
        msg_prefix = prepared_msg[0:32]

    wrap_print("msg_prefix = {}".format(msg_prefix.hex()))
    wrap_print("prepared_msg = {}".format(prepared_msg.hex()))

    public_key = secret_key.public_key()
    blinded_msg, inv = None, None
    while True:
        try:
            blinded_msg, inv = rsabssa_blind(public_key, prepared_msg, sLen, r, salt)
        finally:
            break
    blind_sig = rsabssa_blind_sign(secret_key, blinded_msg)
    sig = rsabssa_finalize(public_key, blind_sig, inv, prepared_msg, sLen)
...
def test_RSABSSA_SHA384_PSS_Randomized() -> None:
    ...
    r = 
    sLen = 48
    salt = I2OSP(
...
def test_deterministic() -> None:
    ...
    r = 
    sLen = 0
    secret_key = RSA.construct((n, e, d, p, q), consistency_check=True)
    test(
        "deterministic",
