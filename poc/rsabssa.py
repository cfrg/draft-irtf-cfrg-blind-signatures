...
def EMSA_PSS_ENCODE(kBits: int, msg: bytes, sLen: int, salt: bytes = None) -> bytes:
    ...
    print("encoded_msg = {}".format(encoded_msg.hex()))
...
def test(
    ...
    print("p = {}".format(hex(secret_key.p)))
    print("q = {}".format(hex(secret_key.q)))
    print("n = {}".format(hex(secret_key.n)))
    print("e = {}".format(hex(secret_key.e)))
    print("d = {}".format(hex(secret_key.d)))
    print("msg = {}".format(msg.hex()))
    print("inv = {}".format(inv.hex()))
    print("blinded_msg = {}".format(blinded_msg.hex()))
    print("blind_sig = {}".format(blind_sig.hex()))
    print("sig = {}".format(sig.hex()))


def test_probabilistic() -> None:
    msg = I2OSP(
...
def test_deterministic() -> None:
    ...
    sLen = 0
    secret_key = RSA.construct((n, e, d, p, q), consistency_check=True)
    test("deterministic", msg=msg, secret_key=secret_key, r_inv=r_inv, sLen=sLen)
